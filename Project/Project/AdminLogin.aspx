...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <table width="60%" style="border: 1px solid #C0C0C0; background-image: url('../Images/bg1.jpg'); " class="intLog">
            <tr>
                <td class="intLog"
                    style="background-image: url('Images/bg3.jpg'); color: #FFFFFF; background-color: #DADADA; width: 0.1%;" 
                    align="center">
                    <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="False" ImageUrl="~/Images/back.png" PostBackUrl="~/MainLogin.aspx" Width="40px" />
                    </td>
                <td width="50%" class="intLog"
                    style="background-image: url('Images/bg3.jpg'); color: #FFFFFF; background-color: #006600; width: 25%;" 
                    align="center">
                    <asp:Label ID="Label1" runat="server" Text="-- Admin Login --" Font-Size="XX-Large" 
