    ...
    <table style="border: 1px solid #C0C0C0; background-image: url('Images/bg.jpg'); " 
        ...
        <tr>
            <td colspan="4" 
                ...
                <asp:Label ID="Label3" runat="server" style="font-family: calibri; font-size: xx-large; color: #FFFFFF;" Text="-- Add Doctor --"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td colspan="2">
                <asp:TextBox ID="TextBox6" runat="server" CssClass="style12" 
                    placeholder="  Speciality In" required="Required" TextMode="Password" 
